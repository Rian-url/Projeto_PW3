  ...
  <body>
	...
	<br>
		<div class="row">
			<div class="col"></div>
			<div class="col-6">
          <h1 class="text-center bg-success text-white">CONSULTAR FORNECEDORS</h1>
					<?php
                           ...
                           {	   
                             ...
                             {		
                               ...
                               echo " <br/> <button type='button' class='btn btn-danger' onclick='javascript:location.href =`excluirFornecedor.php?id=" . $cd . "`'>Deletar</button>";
                               echo "<hr>";
                             }
                           } 
      ...
      <button type="button" class="btn btn-success" onclick="javascript:location.href ='alterarFornecedor.php';">Alterar dados</button>
		</div>
	</div>
  </body>
</html>